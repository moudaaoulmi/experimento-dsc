...
public class MessageResourceBundle
{
    ...
    private static boolean DEBUG_MESSAGE_BUNDLE = false;
    ...
    private static class MessagesProperties extends Properties
    {
        ...
        public synchronized Object put(Object key, Object value)
        {
            ...
            {
                coreHandler.messageResourceBundlePut(e, "Exception setting field value.");
            }
            return null;
        }
    }
    ...
    private static void computeMissingMessages(String bundleName, Class clazz, Map fieldMap,
            Field[] fieldArray, boolean isAccessible)
    {
        ...
        for (int i = 0; i < numFields; i++)
        {
            ...
            {
                coreHandler.messageResourceBundlePut(e, "Error setting the missing message value for: " + field.getName());
    ...
    public static void load(final String bundleName, Class clazz)
    {
        ...
        for (int i = 0; i < variants.length; i++)
        {
            ...
            {
                coreHandler.messageResourceBundlePut(e, "Error loading " + variants[i]);
            }
            finally
            {
                coreHandler.messageResourceBundleLoad(input);
            }
        }
    ...
    {
        if (adaptor != null)
            adaptor.getFrameworkLog().log(
                    new FrameworkLogEntry(FrameworkAdaptor.FRAMEWORK_SYMBOLICNAME + ' ' + severity
                            + ' ' + 1, msg, 0, e, null));
        else
        {

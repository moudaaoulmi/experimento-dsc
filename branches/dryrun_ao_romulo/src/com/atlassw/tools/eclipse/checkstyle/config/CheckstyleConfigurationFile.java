...
/**
 * Simple object containing all sort of data of a Checkstyle configuration. This
 * is done to not access the Checkstyle configuration file too many times to get
...
public class CheckstyleConfigurationFile
{
    ...
    /**
     * Returns an input stream containing the contents of the Checkstyle
     * configuration file.
     * 
    ...
    /**
     * Returns an <code>ByteArrayInputStream</code> of the addional property
     * bundle.
     * 
    ...
    /**
     * Returns the resolved URL of the Checkstyle configuration file. Clients
     * are expected to <b>not</b> use this to access the underlying Checkstyle
     * configuration file
     * 

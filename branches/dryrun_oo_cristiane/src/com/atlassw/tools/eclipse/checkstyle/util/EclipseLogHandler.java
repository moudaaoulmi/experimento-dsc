...
public class EclipseLogHandler extends Handler
{
    ...
    /**
     * Creates an handler that passes java.util.logging messages to the eclipse
     * log of a certain plugin.
     * 
     * @param loggingPlugin the plugin for which should be logged
     */
    ...
    public void publish(LogRecord record)
    {
        ...
        Status status = new Status(severity, mPluginID, Status.OK, NLS.bind(

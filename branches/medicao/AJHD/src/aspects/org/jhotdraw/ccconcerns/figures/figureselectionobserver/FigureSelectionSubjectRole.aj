...
public privileged aspect FigureSelectionSubjectRole {
	 ...
	 * @param fsl jhotdraw.framework.FigureSelectionListener
	 */
	public void StandardDrawingView.addFigureSelectionListener(FigureSelectionListener fsl) {
	 ...
	 * @param fsl jhotdraw.framework.FigureSelectionListener
	 */
	public void StandardDrawingView.removeFigureSelectionListener(FigureSelectionListener fsl) {
	 ...
	 * @param fsl jhotdraw.framework.FigureSelectionListener
	 */
	public void NullDrawingView.addFigureSelectionListener(FigureSelectionListener fsl) {
		// ignore: do nothing
	}
	 ...
	 * @param fsl jhotdraw.framework.FigureSelectionListener
	 */
	public void NullDrawingView.removeFigureSelectionListener(FigureSelectionListener fsl) {
		// ignore: do nothing
	}

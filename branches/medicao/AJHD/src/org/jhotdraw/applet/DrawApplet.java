...
//		DrawApplet da = new DrawApplet();
//		CommandButton cb = (CommandButton)da.button;
//		cb.actionPerformed(new ActionEvent("obj",1,"comand"));
//		
//		da.imageUpdate(new BufferedImage(2,2,2), 2, 2, 2, 2, 2);
//		da.imageUpdate(new DoubleBufferImage(new BufferedImage(2,2,2),2), 2, 2, 2, 2, 2);
//		//da.imageUpdate(new ToolkitImage(new ImageProducer()), 2, 2, 2, 2, 2);
//		
//	}
}

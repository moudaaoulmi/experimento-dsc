...
public class CheckstylePreferencePage extends PreferencePage implements IWorkbenchPreferencePage
{
    ...
    public boolean performOk()
    {
        ...
        if (rebuild)
        {
            internarPerformOkInternal(needRebuildAllProjects, projectsToBuild,getShell());
        }
    ...
    /*private void internalPerformOk(Shell shell)
    {
        //
        // Save the check configurations.
        //
        ...
        if (rebuild)
        {
            internarPerformOkInternal(needRebuildAllProjects, projectsToBuild,shell);
        }
    }*/

    private void internarPerformOkInternal(boolean needRebuildAllProjects,
            Collection projectsToBuild,Shell shell)
    {

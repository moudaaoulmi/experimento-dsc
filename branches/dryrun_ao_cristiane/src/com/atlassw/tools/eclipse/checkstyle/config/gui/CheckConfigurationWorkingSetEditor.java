...
public class CheckConfigurationWorkingSetEditor
{
            ...
            ISelectionChangedListener
    {
        ...
        public void selectionChanged(SelectionChangedEvent event)
        {
                    ...
                    && event.getSelection() instanceof IStructuredSelection)
            {
                ...
                if (config != null)
                {
                    ...
                    if (mIsShowUsage)
                    {
                        internalSelectionChanged(config);
                    }
                }
                else
                {
        ...
        private void internalSelectionChanged(CheckConfigurationWorkingCopy config)
        {
            mUsageView.setInput(ProjectConfigurationFactory.getProjectsUsingConfig(config
    ...
    private void configureCheckConfig()
    {
        ...
        if (config != null)
        {
            internalConfigureCheckConfig(config);
        }
    }

    private void internalConfigureCheckConfig(CheckConfigurationWorkingCopy config)
    {
        // test if file exists

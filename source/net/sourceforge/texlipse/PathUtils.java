/*
 * $Id: PathUtils.java,v 1.7 2008/02/24 21:43:08 borisvl Exp $
 *
...
public class PathUtils {
	...
	public static Map<String, String> getPreferenceMap(String name) {
		...
		for (int i = 0; i < binds.length; i++) {
			...
			map
					.put(binds[i].substring(0, index), binds[i]
							.substring(index + 1));
		}
	 ...
	 */
	public static String findEnvFile(String file, String path, String winFile,
			String winPath) {
	 ...
	 */
	public static String findInEnvPath(String file, String path,
			String winFile, String winPath) {
		// default binary file to search for in the path
		String defaultFile = file;
		String defaultPath = path;

...
public class TexParser {
	...
	static String extractLaTeXPreamble(String input) {
		...
		IRegion region = LatexParserUtils.findBeginEnvironment(input,
				"document", 0);
		if (region != null) {
	...
	public void parseDocument(ReferenceContainer labels,
			ReferenceContainer bibs, boolean checkForMissingSections)
			throws IOException {
	 ...
	 */
	public void parseDocument(ReferenceContainer labels,
			ReferenceContainer bibs, String input,
		...
		internalParseDocument(labels, bibs, input, checkForMissingSections);
	}

	private void internalParseDocument(ReferenceContainer labels,
			ReferenceContainer bibs, String input,
			boolean checkForMissingSections) throws IOException {
		// start the parse

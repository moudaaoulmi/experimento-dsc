/*
 * $Id: TexLaunchConfigurationDelegate.java,v 1.5 2006/05/05 09:13:11 torarnv Exp $
 *
...
public class TexLaunchConfigurationDelegate extends LaunchConfigurationDelegate {
	...
	public void launch(ILaunchConfiguration configuration, String mode,
		...
		Map addEnv = configuration.getAttribute(
		...
		// if this process is added to launcer, the output will not be parsed
		// correctly

 ...
 */
package ish.ecletex.wordnet.jwnl.data;
...
import ish.ecletex.wordnet.jwnl.data.list.PointerTargetTree;
import ish.ecletex.wordnet.jwnl.data.list.PointerTargetTreeNode;
import ish.ecletex.wordnet.jwnl.data.list.PointerTargetTreeNodeList;
			...
			if (targets.size() > 0) {
				for (Iterator itr = targets.iterator(); itr.hasNext();) {
					PointerTargetTreeNode node =
					    new PointerTargetTreeNode(((PointerTargetNode) itr.next()).getPointerTarget(),

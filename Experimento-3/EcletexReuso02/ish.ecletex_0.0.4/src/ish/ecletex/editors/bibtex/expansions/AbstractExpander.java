...
public abstract class AbstractExpander {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ish.ecletex.editors.bibtex.expansions.Expander#getExceptions()
	 */
	...
	/**
	 * Call this whenever you want to throw an ExpansionException. This method
	 * may or may not throw the exception, depending on the
	 * throwAllExpansionExceptions flag.
	 * 
	 * @param message
	...
	protected void throwExpansionException(String message)
		...
		if (this.throwAllExpansionExceptions)
			...
			internalThrowExpansionException(message);
		}
	}

	private void internalThrowExpansionException(String message) {
		throw new ExpansionException(message);
	}
	...
	protected void throwExpansionException(Exception cause)
		...
		if (this.throwAllExpansionExceptions)
			...
			internalThrowExpansionException(cause);
		}
	}

	private void internalThrowExpansionException(Exception cause) {
		throw new ExpansionException(cause);
	}

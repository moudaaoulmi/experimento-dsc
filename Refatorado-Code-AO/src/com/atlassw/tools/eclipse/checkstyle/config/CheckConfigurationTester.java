...
public class CheckConfigurationTester
{
    ...
    public List getUnresolvedProperties() throws CheckstylePluginException
    {
        ...
        InputStream in = null;
        getUnresolvedPropertiesIteration(configFile, resolver, contextClassloader, in);

        return collector.getUnresolvedProperties();
    }

    private void getUnresolvedPropertiesIteration(CheckstyleConfigurationFile configFile,
            PropertyResolver resolver, ClassLoader contextClassloader, InputStream in)

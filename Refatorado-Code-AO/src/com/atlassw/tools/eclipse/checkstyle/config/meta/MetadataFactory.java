...
public final class MetadataFactory
{
    ...
    public static RuleMetadata createGenericMetadata(Module module)
    {
        ...
        String parent = null;
        parent = internalRuleMetadata(module,parent);
    ...
    private static String internalRuleMetadata(Module module,String parent)
    {
    ...
    private static void doInitialization() throws CheckstylePluginException
    {
        ...
        internalDo(contextClassLoader);
    }

    private static void internalDo(ClassLoader contextClassLoader)
        throws CheckstylePluginException
    {
        ...
        while (it.hasNext())
        {
            ...
            internalDoInitialization(customsLoader, metadataFile, metadataStream);
        }
    }

    private static void internalDoInitialization(ClassLoader customsLoader, String metadataFile,
    ...
    private static class MetaDataHandler extends DefaultHandler
    {
            ...
            if (XMLTags.RULE_GROUP_METADATA_TAG.equals(qName))
            {
                ...
                if (mCurrentGroup == null)
                {
                    ...
                    boolean hidden = Boolean.valueOf(attributes.getValue(XMLTags.HIDDEN_TAG))
                            .booleanValue();
                    int priority = 0;
                    priority = internalStartElement(attributes,priority);
        ...
        private int internalStartElement(Attributes attributes,int priority)
        {

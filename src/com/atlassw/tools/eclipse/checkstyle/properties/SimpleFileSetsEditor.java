...
public class SimpleFileSetsEditor implements IFileSetsEditor
{
    ...
    public Text getMTxtConfigDescription()
    {
        return mTxtConfigDescription;
    }

    public void setMTxtConfigDescription(Text txtConfigDescription)
    {
        mTxtConfigDescription = txtConfigDescription;
    }

    public Button getMBtnManageConfigs()
    {
        return mBtnManageConfigs;
    }

    public void setMBtnManageConfigs(Button btnManageConfigs)
    {
        mBtnManageConfigs = btnManageConfigs;
    }
    ...
    public FileSet getMDefaultFileSet()
    {
        return mDefaultFileSet;
    }

    public void setMDefaultFileSet(FileSet defaultFileSet)
    {
        mDefaultFileSet = defaultFileSet;
    }

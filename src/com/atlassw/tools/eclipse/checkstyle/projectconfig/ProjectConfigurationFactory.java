...
public final class ProjectConfigurationFactory
{
        ...
        throws CheckstylePluginException
    {
        ...
        configuration = internalLoadFromPersistence(project, configuration, file, inStream);

        return configuration;
    }

    private static IProjectConfiguration internalLoadFromPersistence(IProject project,

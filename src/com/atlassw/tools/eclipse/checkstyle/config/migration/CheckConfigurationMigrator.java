...
public final class CheckConfigurationMigrator
{
     ...
     * @author Lars Ködderitzsch
     */
    public static class OldConfigurationHandler extends DefaultHandler
    {
        /** the working set. */
        ...
        public CheckConfigurationWorkingCopy getMCurrentConfiguration()
        {
            return mCurrentConfiguration;
        }

        public void setMCurrentConfiguration(CheckConfigurationWorkingCopy currentConfiguration)
        {
            mCurrentConfiguration = currentConfiguration;
        }

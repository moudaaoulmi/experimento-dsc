...
public class CheckConfigurationPropertiesDialog extends TitleAreaDialog
{
     ...
     * @param checkConfig the check configuration or <code>null</code> if a new
     *            check config should be created
    ...
    protected void okPressed()
    {
        ...
        if (!unresolvedProps.isEmpty())
        {
            ...
            MessageDialog dialog = new MessageDialog(getShell(),
                    Messages.CheckConfigurationPropertiesDialog_titleUnresolvedProps, null, NLS
                            .bind(Messages.CheckConfigurationPropertiesDialog_msgUnresolvedProps,

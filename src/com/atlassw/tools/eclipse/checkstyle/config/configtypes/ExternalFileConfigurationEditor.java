...
public class ExternalFileConfigurationEditor implements ICheckConfigurationEditor
{
    ...
    private ConfigtypesHandler configtypesHandler = new ConfigtypesHandler();
    ...
    private boolean ensureFileExists(String location) throws CheckstylePluginException
    {
        ...
        if (!file.exists())
        {
            ...
            if (confirm)
            {
                ...
                {
                    configtypesHandler.rethrowCheckstylePluginException(ioe);
                }
                finally
                {
                    configtypesHandler.closeQuietlyOutputStream(out);
                }
                return true;
            }
            else

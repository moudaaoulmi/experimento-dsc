...
public final class ConfigurationTypes
{
    ...
    private static void internalStatic(IConfigurationElement[] elements, int i)
    {
        ...
        Class editorClass = elements[i].getAttributeAsIs(ATTR_EDITOR) == null ? null : Class
                .forName(elements[i].getAttributeAsIs(ATTR_EDITOR));
        ...
        configType.initialize(name, internalName, editorClass, icon, definingPluginId, isCreatable,

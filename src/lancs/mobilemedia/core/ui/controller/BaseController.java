...
public class BaseController extends AbstractController {
    ...
    /* (non-Javadoc)
     * @see ubc.midp.MobileMedia.core.ui.controller.ControllerInterface#handleCommand(javax.microedition.lcdui.Command)
     */
    public boolean handleCommand(Command command) {
		...
		//will pass the request to the next controller in the chain if one exists.
      	...
      	System.out.println( this.getClass().getName() + "<* BaseController.handleCommand() *> " + label);

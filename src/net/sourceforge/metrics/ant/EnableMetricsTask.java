...
/**
 * Add metrics nature and build command to the project specified in the task
 * parameters
 * 
 * @author Frank Sauer
 */
public class EnableMetricsTask extends Task {
	...
	public void execute() throws BuildException {
		...
		internalExecute(project);
	}

	private void internalExecute(IProject project) throws BuildException {
	...
	public void setFailonerror(String str) {
		if (str.equals("true"))
			...
			failOnError = true;
			displayError("Invalid failonerror=" + str

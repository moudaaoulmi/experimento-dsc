...
/**
 * Counts the number of attributes in a class. Distinguishes between statics and
 * instance fields, sets NUM_FIELDS and NUM_STAT_FIELDS
 * 
 * @author Frank Sauer
 */
	...
	public void calculate(AbstractMetricSource source)
		...
		if (source.getLevel() != TYPE)
			throw new InvalidSourceException(
					"NumberOfAttributes is only applicable to types");

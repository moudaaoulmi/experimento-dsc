/*
 * $Id: ViewerErrorScanner.java,v 1.1 2005/03/16 12:22:32 kimmok Exp $
 *
...
public class ViewerErrorScanner implements Runnable {
	...
	public void run() {
		...
		String tmp = null;
		internalRun(in, buffer, tmp);

		int exitCode = 0;
		exitCode = internalRun(exitCode);
	...
	private int internalRun(int exitCode) {
		exitCode = process.waitFor();
		return exitCode;
	}

	private void internalRun(BufferedReader in, ArrayList buffer, String tmp) {

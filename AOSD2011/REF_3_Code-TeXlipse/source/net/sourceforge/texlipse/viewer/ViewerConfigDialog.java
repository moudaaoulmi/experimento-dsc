...
public class ViewerConfigDialog extends Dialog {
	...
	private static final String[] inverseSearchValues = new String[] {
			ViewerAttributeRegistry.INVERSE_SEARCH_NO,
			ViewerAttributeRegistry.INVERSE_SEARCH_RUN,
			ViewerAttributeRegistry.INVERSE_SEARCH_STD };
	...
	protected void configureShell(Shell newShell) {
		...
		if (newConfig) {
			newShell.setText(TexlipsePlugin
					.getResourceString("preferenceViewerDialogAddTitle"));
		} else {
			newShell.setText(TexlipsePlugin
					.getResourceString("preferenceViewerDialogEditTitle"));
		}
	}
	...
	protected void okPressed() {
		...
		registry.setFormat(formatChooser.getItem(formatChooser
				.getSelectionIndex()));
		registry.setInverse(inverseSearchValues[inverseChooser
				.getSelectionIndex()]);
		registry.setForward(forwardChoice.getSelection());

		// Ask user if launch configs should be updated
		internalOkPressed(name);

		setReturnCode(OK);
		close();
	}

	private void internalOkPressed(String name) {
				...
				if (configs != null) {
					...
					for (int i = 0; i < configs.length; i++) {
						...
						if (c
							...
							if (c.getAttribute("viewerCurrent", "")
									.equals(name)) {
								...
								if (returnCode == IDialogConstants.YES_ID) {
									ILaunchConfigurationWorkingCopy workingCopy = c
											.getWorkingCopy();
									...
									workingCopy.setAttribute("viewerCurrent",
											name);
									workingCopy.doSave();
								}
	...
	protected Control createDialogArea(Composite parent) {
		...
		descrLabel.setText(TexlipsePlugin
				.getResourceString("preferenceViewerDescriptionLabel"));
		...
		statusField.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerStatusTooltip"));
	...
	private void addConfigNameField(Composite composite) {
		...
		nameLabel.setText(TexlipsePlugin
				.getResourceString("preferenceViewerNameLabel"));
		nameLabel.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerNameTooltip"));
		...
		nameField.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerNameTooltip"));
	...
	private void addFileBrowser(Composite composite) {
		...
		fileLabel.setText(TexlipsePlugin
				.getResourceString("preferenceViewerCommandLabel"));
		fileLabel.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerCommandTooltip"));
		...
		fileField.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerCommandTooltip"));
	...
	private void addArgumentsField(Composite composite) {
		...
		argsLabel.setText(TexlipsePlugin
				.getResourceString("preferenceViewerArgumentLabel"));
		argsLabel.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerArgumentTooltip"));
		...
		argsField.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerArgumentTooltip"));
	...
	private void addDDEGroups(Composite composite) {
		...
		ddeViewGroup = new DDEGroup(composite, TexlipsePlugin
				.getResourceString("preferenceViewerDDEViewLabel"),
				TexlipsePlugin
						.getResourceString("preferenceViewerDDEViewTooltip"));
		...
		ddeCloseGroup = new DDEGroup(composite, TexlipsePlugin
				.getResourceString("preferenceViewerDDECloseLabel"),
				TexlipsePlugin
						.getResourceString("preferenceViewerDDECloseTooltip"));
	...
	private void addFormatChooser(Composite composite) {
		...
		formatLabel.setText(TexlipsePlugin
				.getResourceString("preferenceViewerFormatLabel"));
		formatLabel.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerFormatTooltip"));
		...
		formatChooser.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerFormatTooltip"));
	...
	private void addInverseChooser(Composite parent) {
		...
		label.setText(TexlipsePlugin
				.getResourceString("preferenceViewerInverseLabel"));
		label.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerInverseTooltip"));
		label.setLayoutData(new GridData());

		String[] list = new String[] {
				TexlipsePlugin
						.getResourceString("preferenceViewerInverseSearchNo"),
				TexlipsePlugin
						.getResourceString("preferenceViewerInverseSearchRun"),
				TexlipsePlugin
						.getResourceString("preferenceViewerInverseSearchStd") };

		// find out which option to choose by default
		int index = inverseSearchValues.length - 1;
		for (; index > 0
				&& !inverseSearchValues[index].equals(registry.getInverse()); index--) {
		}

		inverseChooser = new Combo(parent, SWT.DROP_DOWN | SWT.READ_ONLY);
		inverseChooser.setLayoutData(new GridData());
		inverseChooser.setToolTipText(TexlipsePlugin
				.getResourceString("preferenceViewerInverseTooltip"));
	...
	private void addForwardChooser(Composite parent) {
		...
		forwardChoice.setText(TexlipsePlugin
				.getResourceString("preferenceViewerForwardLabel"));
	...
	private class DDEGroup extends Composite {
		...
		public DDEGroup(Composite parent, String name, String toolTip) {
			...
			ddeCommandLabel.setText(TexlipsePlugin
					.getResourceString("preferenceViewerDDECommandLabel"));
			ddeCommandLabel.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDECommandTooltip"));
			ddeCommandLabel.setLayoutData(new GridData());

			command = new Text(group, SWT.SINGLE | SWT.BORDER);
			command.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDECommandTooltip"));
			...
			ddeServerLabel.setText(TexlipsePlugin
					.getResourceString("preferenceViewerDDEServerLabel"));
			ddeServerLabel.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDEServerTooltip"));
			ddeServerLabel.setLayoutData(new GridData());

			server = new Text(group, SWT.SINGLE | SWT.BORDER);
			server.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDEServerTooltip"));
			server.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));

			Label ddeTopicLabel = new Label(group, SWT.LEFT);
			ddeTopicLabel.setText(TexlipsePlugin
					.getResourceString("preferenceViewerDDETopicLabel"));
			ddeTopicLabel.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDETopicTooltip"));
			ddeTopicLabel.setLayoutData(new GridData());

			topic = new Text(group, SWT.SINGLE | SWT.BORDER);
			topic.setToolTipText(TexlipsePlugin
					.getResourceString("preferenceViewerDDETopicTooltip"));

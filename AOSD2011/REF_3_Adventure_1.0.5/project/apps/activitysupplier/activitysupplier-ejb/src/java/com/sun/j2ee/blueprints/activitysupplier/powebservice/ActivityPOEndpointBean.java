...
public class ActivityPOEndpointBean implements SessionBean {
	...
	private void submitRequest(ActivityOrder act)
		...
		internalSubmitRequest(act, jmsConnectionFactory, jmsDest,
				jmsConnection, jmsSession, jmsSender);
	}

	private void internalSubmitRequest(ActivityOrder act,
		...
		jmsConnectionFactory = (ConnectionFactory) sl
				.getJMSConnectionFactory(JNDINames.ACT_QUEUECONNECTIONFACTORY);

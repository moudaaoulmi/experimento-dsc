...
/**
 * This object is represents the purchase order that is persisted after a user
 * places an order.
 */
public class PurchaseOrder implements Serializable {
	...
	public PurchaseOrder(String poId, String userId, String emailId,
			String locale, Calendar orderDate, ContactInfo shippingInfo,
			ContactInfo billingInfo, float totalPrice, CreditCard creditCard,
			int headCount, Calendar startDate, Calendar endDate,
			String departureCity, Activity[] activities, Lodging lodging,
			Transportation departureFlightInfo, Transportation returnFlightInfo) {
		this.poId = poId;

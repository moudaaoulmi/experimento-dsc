...
public class DAOFactory {
	 ...
	 * 
	 * @param daoEnvEntry
	 *            The env-entry in the deployment descriptor that contains the
	 *            name of the class corresponding to which DAO to instantiate.
	 * 
	 * @throws DAOSystemException
	 *             if it has system error looking up the DAO class name in the
	 *             env-entry.
	 */

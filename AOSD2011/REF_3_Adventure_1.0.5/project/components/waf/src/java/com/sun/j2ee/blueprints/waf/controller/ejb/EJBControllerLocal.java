 ...
 * EJB. It controls all the activities that happen in a client session. It also
 * provides mechanisms to access other session EJBs.
 */
public interface EJBControllerLocal extends EJBLocalObject {
	 ...
	 */
	public EventResponse processEvent(Event ese) throws EventException;
}

...
/**
 * HTML 'select' tag. By default @param isEditable is set to true. This tag
 * contains a set of OptionTags in it's body which while look up this tag and
 * add the options. This tag allows you to just display the OptionTag that is
 * selcted when @param isEditable is set to false otherwise the selected item is
 * pre-selected in the page.
 */
public class SelectTag extends BodyTagSupport {
	...
	public void setOnChange(String oc) {
		onChange = oc;
	}

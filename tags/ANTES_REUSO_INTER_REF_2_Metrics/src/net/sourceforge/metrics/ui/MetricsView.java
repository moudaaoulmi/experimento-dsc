...
public class MetricsView extends ViewPart implements ISelectionListener,
		IMetricsProgressListener, IPropertyChangeListener {
	...
	private void displayDependencyGraphSWT(final Map graph) {
		...
		if (page != null) {
			DependencyGraphView v = (DependencyGraphView) page
					.findView("net.sourceforge.metrics.ui.DependencyGraphView");
			if (v == null) {
	 ...
	 * 
	 * @see
	 * net.sourceforge.metrics.core.MetricsBuilder.MetricsProgressListener#pending
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * net.sourceforge.metrics.core.MetricsBuilder.MetricsProgressListener#completed
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * net.sourceforge.metrics.core.MetricsBuilder.MetricsProgressListener#moved

...
/**
 * Interface for implementations that provide editing services for a group of
 * check configuration.
 * 
...
{
    /**
     * Creates a new working copy for an existing check configuration. The
     * working copy is associated with this working set albeit the new working
     * copy is not added to the working sets list of workin copies.
     * 
     * @param checkConfig the check configuration to create the working copy for
     * @return the working copy
     */
    CheckConfigurationWorkingCopy newWorkingCopy(ICheckConfiguration checkConfig);

    /**
     * Creates a new working copy with a given configuration type. The working
     * copy is associated with this working set albeit the new working copy is
     * not added to the working sets list of workin copies.
     * 
     * @param configType the desired configuration type of the new working copy
     * @return the working copy
     */
    ...
    /**
     * Checks if the name of a check configuration (in form of a working copy)
     * clashes with an existing configuration. Names of check configurations
     * must be unique within the working copy.
     * 
     * @param configuration the working copy to check
     * @return <code>true</code> if there is a collision, <code>false</code>
     *         otherwise
     */
     ...
     * 
     * @param checkConfig the working copy to add
     */
     ...
     * 
     * @throws CheckstylePluginException when storing of the configurations
     *             failed
     */

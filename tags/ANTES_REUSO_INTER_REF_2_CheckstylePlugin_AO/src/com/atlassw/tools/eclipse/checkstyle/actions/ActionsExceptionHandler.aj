...
@ExceptionHandler
public privileged aspect ActionsExceptionHandler
{
    // ---------------------------
    // Declare soft's
    // ---------------------------
    ...
    pointcut ConfigureProjectFromBluePrintActionHandle_runInWorkspaceHandle():  
        execution (public IStatus  ConfigureProjectFromBluePrintAction.BulkConfigureJob.runInWorkspace(IProgressMonitor));

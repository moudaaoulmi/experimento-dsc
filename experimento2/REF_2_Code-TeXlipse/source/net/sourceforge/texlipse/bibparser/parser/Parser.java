...
public class Parser {
	...
	ArrayList new5() /* reduce AAstrbracestringentry1StringEntry */
	{
		...
		PStringEntry pstringentryNode1;
		{
			...
			pstringentryNode1 = new AStrbraceStringEntry(tidentifierNode2,
					tstringliteralNode3);
		}
	...
	ArrayList new9() /* reduce AAstrparenstringentry1StringEntry */
	{
		...
		PStringEntry pstringentryNode1;
		{
			...
			pstringentryNode1 = new AStrparenStringEntry(tidentifierNode2,
					tstringliteralNode3);
		}
		nodeList.add(pstringentryNode1);
		return nodeList;
	...
	ArrayList new13() /* reduce AAentrybraceentry1Entry */
	{
		...
		PEntry pentryNode1;
		{
			...
			pentryNode1 = new AEntrybraceEntry(pentrydefNode2,
					tidentifierNode3, listNode5, trbraceNode6);
		}
	...
	ArrayList new15() /* reduce AAentryparenentry1Entry */
	{
		...
		PEntry pentryNode1;
		{
			...
			pentryNode1 = new AEntryparenEntry(pentrydefNode2,
					tidentifierNode3, listNode5, trparenNode6);
		}
		nodeList.add(pentryNode1);
		return nodeList;
	}
	...
	ArrayList new18() /* reduce AAkeyvaldecl1KeyvalDecl */
	{
		...
		PKeyvalDecl pkeyvaldeclNode1;
		{
			...
			pkeyvaldeclNode1 = new AKeyvalDecl(tidentifierNode2,
					pvalorsidNode3, listNode4);
		}

/*
 * $Id: FileLocationServer.java,v 1.1 2005/03/16 12:22:32 kimmok Exp $
 *
...
public class FileLocationServer implements Runnable {
	...
	private void internalRun() {
		ssocket = new ServerSocket(TexlipsePlugin.getDefault()
				.getPreferenceStore().getInt(
						TexlipseProperties.FILE_LOCATION_PORT));
	}
	...
	private void parseLine(String line) {
		...
		if (index > 0) {
			...
			int lineNumber = -1;
			lineNumber = internalParseLine(num, lineNumber);
	...
	private int internalParseLine(String num, int lineNumber) {

/*
 * $Id: TexPairMatcher.java,v 1.3 2006/10/11 20:13:36 borisvl Exp $
 *
...
public class TexPairMatcher implements ICharacterPairMatcher {
	...
	public TexPairMatcher(String pairs) {
		...
		if ((pairs.length() % 2) == 1) {
			TexlipsePlugin
					.stat("Bad parameter for TexPairMatcher constructor: "
							+ pairs);
			this.pairs = "";
		}
	}
	...
	public IRegion match(IDocument document, int offset) {
		...
		if ((index % 2) == 1) {
			...
			peerIndex = LatexParserUtils.findPeerChar(docString, offset,
					fAnchor, pairs.charAt(index), pairs.charAt(index - 1));
			if (peerIndex != -1)

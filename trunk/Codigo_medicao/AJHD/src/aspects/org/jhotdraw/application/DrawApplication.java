...
public	class DrawApplication
	...
	public CommandMenu aligMenu = null;
	public JMenu attributesMenu = null;
	public CommandMenu debMenu = null;
	public CommandMenu colorMenu1 = null;
	public CommandMenu colorMenu2 = null;
	public CommandMenu arrowMenu = null;
	public CommandMenu fontMenu = null;
...
//		this("JHotDraw");
	...
	public void newWindow(Drawing initialDrawing) {
		...
		if (initialDrawing == null) {
			...
			System.out.println("open(completo)");
	...
	protected void createMenus(JMenuBar mb) {
		...
		System.out.println("Entrou na criacao dos menusssss!");
		
		fileMenu = (CommandMenu)createFileMenu();
		editMenu = (CommandMenu) createEditMenu();
		aligMenu = (CommandMenu) createAlignmentMenu();
		//Esse 'e um JMenu com varios command menus dentro
		attributesMenu = (JMenu) createAttributesMenu();
		debMenu = (CommandMenu) createDebugMenu();
		
		addMenuIfPossible(mb, fileMenu);
		addMenuIfPossible(mb, editMenu);
		addMenuIfPossible(mb, aligMenu);
		addMenuIfPossible(mb, attributesMenu);
		addMenuIfPossible(mb, debMenu);
	}
...
public static void main(String[] args) {
	...
	draw.open();
//	draw.newWindow();
//	executeCommandMenu(draw.fileMenu);
//	executeCommandMenu(draw.editMenu);
//	executeCommandMenu(draw.aligMenu);
//	//executeMenu(draw.attributesMenu);
//	executeCommandMenu(draw.debMenu);
//	
//	executeCommandMenu(draw.colorMenu1);
//	executeCommandMenu(draw.colorMenu2);
//	executeCommandMenu(draw.colorMenu3);
//	executeCommandMenu(draw.arrowMenu);
//	executeCommandMenu(draw.fontMenu);
//	executeCommandMenu(draw.fontSizeMenu);
//	executeCommandMenu(draw.fontStylrMenu);
...
//
//// esecutar comandos do fileMenu
//for (int i=0; i<numCom; i++){
//	draw.fileMenu.actionPerformed(vecEventos(numCom));
//}
//
//int num = filemenu.getMenuComponentCount();
//for (int i=0; i<num;i++ ){
//	Component comp = filemenu.getComponent(i);
//	comp.action(evt, what);
//}


// Se o source do evento eh igual ao item de 
//menu ele executa o comando associado ao menu.

 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class TeXOptionalScanner extends RuleBasedScanner {
	public TeXOptionalScanner(ColorManager manager,TeXEditor editor) {
		IToken numberToken =
			new Token(
				new TextAttribute(
						manager.getColor(TexColorsPreferencePage.OPTIONAL_COLOR)));
		IToken commandToken =
			new Token(
				new TextAttribute(

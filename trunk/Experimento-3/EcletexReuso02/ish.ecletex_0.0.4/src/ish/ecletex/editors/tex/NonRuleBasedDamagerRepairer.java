...
public class NonRuleBasedDamagerRepairer implements IPresentationDamager,
	...
	protected int endOfLineOf(int offset) throws BadLocationException {
		...
		return internalEndOfLineOf(info, line);
	}

	private int internalEndOfLineOf(IRegion info, int line) {
	...
	public IRegion getDamageRegion(ITypedRegion partition, DocumentEvent event,
		...
		if (!documentPartitioningChanged) {
			return internalGetDamageRegion(partition, event);
		}
		return partition;
	}

	private IRegion internalGetDamageRegion(ITypedRegion partition,
			DocumentEvent event) {

 ...
 * @author Frank Sauer
 */
public class PackageFragmentRootMetrics extends AbstractMetricSource implements
		IGraphContributor {
	...
	private void internalInitializeChildren(IPackageFragmentRoot pack) {
			...
			if (children[i] instanceof IPackageFragment) {
				if (((IPackageFragment) children[i]).containsJavaResources()) {
					...
					if (next != null)
						...
						Log.logMessage("metrics for package "

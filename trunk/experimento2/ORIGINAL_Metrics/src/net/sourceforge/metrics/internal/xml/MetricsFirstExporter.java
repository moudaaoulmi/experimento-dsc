...
public class MetricsFirstExporter implements IExporter, Constants {
	...
	private void printRoot(AbstractMetricSource root, XMLPrintStream pOut, IProgressMonitor monitor) {
	...
	private boolean printValues(String id, AbstractMetricSource element, XMLPrintStream pOut) {
	 ...
	 * @param pOut
	 */
	private void printValues(List values, final String id, XMLPrintStream pOut, MetricDescriptor md) {
		// sort values first

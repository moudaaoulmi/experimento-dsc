...
public class TexTemplateCompletion extends TemplateCompletionProcessor {
	 ...
	 */
	public ArrayList addTemplateProposals(ITextViewer viewer,
			int documentOffset, String prefix) {
	...
	protected String extractPrefix(ITextViewer viewer, int offset) {
		...
		char c = ' ';
		internalExtractPrefix(viewer, i, sb, c);
		return sb.reverse().toString();
	}

	private void internalExtractPrefix(ITextViewer viewer, int i,
			StringBuffer sb, char c) {

...
public class KpsewhichRunner implements ProgramRunner {
	 ...
	 */
	protected String run(String[] command, IResource resource)
			throws CoreException {
		...
		extrun.setup(command, resource.getLocation().toFile().getParentFile(),
				console);
	 ...
	 */
	public String getFile(IResource resource, String filename, String progname)
			throws CoreException {

		String[] command = { getProgramPath(), "-progname=" + progname,
				filename };
	 ...
	 */
	public Kpath[] getSearchPaths(IResource resource, String ext)
			throws CoreException {

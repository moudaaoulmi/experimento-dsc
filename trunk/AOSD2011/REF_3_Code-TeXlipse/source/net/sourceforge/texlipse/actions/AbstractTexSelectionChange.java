 ...
 */
public abstract class AbstractTexSelectionChange implements
	...
	private void change() {
		...
		String replaceText = startTag + selection.getCompleteSelection()
				+ endTag;

		// Replace the text with the modified information
		selection.getDocument().replace(selStart, selection.getSelLength(),
				replaceText);
	...
	private void unchange() {
		...
		// Replace the text with the modified information
		String replaceText = selected.substring(startTag.length(), selected
				.length()
				- endTag.length());
		selection.getDocument().replace(selStart, selection.getSelLength(),
				replaceText);

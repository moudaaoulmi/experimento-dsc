...
public class Transportation implements Serializable {
	...
	public Transportation(String transportationId, String carrier,
			String origin, String destination, Calendar departureDate,
	...
	public String toXML(String poId) throws XMLException {
		...
		elem.appendChild(doc.createTextNode((new SimpleDateFormat("MM-dd-yy"))
				.format(departureDate.getTime())));
		transportElem.appendChild(elem);

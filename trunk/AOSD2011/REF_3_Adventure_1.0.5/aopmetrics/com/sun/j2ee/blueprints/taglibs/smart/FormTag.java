...
/**
 * This tag provides the web page developer with the ability to required form
 * content is provided for specified form fields using JavaScript.
 */
public class FormTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspTagException {
		...
		for (Iterator it = validatedFields.keySet().iterator(); it.hasNext();) {

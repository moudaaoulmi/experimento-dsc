...
public final class I18nUtil extends Object {
	...
	/**
	 * Converts a String SJIS or JIS URL encoded hex encoding to a Unicode
	 * String
	 * 
	 */
	public static String convertJISEncoding(String target) {
		...
		convertedString = internalConvertJISEncoding(bos, convertedString);
		return convertedString;
	}

	private static String internalConvertJISEncoding(ByteArrayOutputStream bos,
			String convertedString) {
		convertedString = new String(bos.toByteArray(), "JISAutoDetect");
		return convertedString;
	}

	public static String formatCurrency(double amount, int precision,
	...
	public static Vector parseKeywords(String keywordString) {
		if (keywordString != null) {
			...
			return internalParseKeywords(keywordString, keywords, breakIt,
					index);
		}
		return null;
	}

	private static Vector internalParseKeywords(String keywordString,
			Vector keywords, BreakIterator breakIt, int index) {
		int previousIndex;
	...
	public static Vector parseKeywords(String keywordString, Locale locale) {
		if (keywordString != null) {
			...
			int previousIndex = 0;
			breakIt.setText(keywordString);
			internalParseKeywords(keywordString, keywords, breakIt, index);

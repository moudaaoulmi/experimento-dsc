...
public class SignOnFilter implements Filter {
	...
	public void init(FilterConfig config) throws ServletException {
		...
		internalInit(config, protectedResourcesURL);
	}

	private void internalInit(FilterConfig config, URL protectedResourcesURL)
	...
	public void validateSignOn(ServletRequest request,
		...
		internalValidateSignOn(hreq, hres, userName, password);
	}

	private void internalValidateSignOn(HttpServletRequest hreq,
			HttpServletResponse hres, String userName, String password) {

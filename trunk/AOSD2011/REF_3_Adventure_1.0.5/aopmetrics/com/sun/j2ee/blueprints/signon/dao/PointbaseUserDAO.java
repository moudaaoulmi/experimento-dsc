...
public class PointbaseUserDAO implements UserDAO {
	...
	public void createUser(String userName, String password)
		...
		internalCreateUser(userName, password, conn, ps);
	}

	private void internalCreateUser(String userName, String password,
			Connection conn, PreparedStatement ps) throws DAOSystemException,
	...
	public boolean matchPassword(String userName, String password)
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		internalMatchPassword(userName, password, conn, ps, rs);
		return (true);
	}

	private void internalMatchPassword(String userName, String password,
			Connection conn, PreparedStatement ps, ResultSet rs)
			throws DAOSystemException, InvalidPasswordException,

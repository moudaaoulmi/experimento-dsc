...
public class AirlinePOEndpointBean implements SessionBean {
	...
	private void submitRequest(AirlineOrder flight)
		...
		internalSubmitRequest(flight, jmsConnectionFactory, dest,
				jmsConnection, jmsSession, jmsSender);
	}

	private void internalSubmitRequest(AirlineOrder flight,
			ConnectionFactory jmsConnectionFactory, Destination dest,
		...
		jmsConnectionFactory = (ConnectionFactory) sl
				.getJMSConnectionFactory(JNDINames.AIRLINE_QUEUECONNECTIONFACTORY);

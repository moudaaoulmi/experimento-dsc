...
public final class TransportSearchHTMLAction extends HTMLActionSupport {
	 ...
	 * database
	 */
	public ArrayList searchTransportation(String origin, String destination,
		...
		transportation = internalSearchTransportation(origin, destination,
	...
	private ArrayList internalSearchTransportation(String origin,
			String destination, Locale locale, ArrayList transportation)
			throws HTMLActionException {
		CatalogFacade catalogFacade = new CatalogFacade();
		transportation = catalogFacade.getTransportations(origin, destination,
				locale);

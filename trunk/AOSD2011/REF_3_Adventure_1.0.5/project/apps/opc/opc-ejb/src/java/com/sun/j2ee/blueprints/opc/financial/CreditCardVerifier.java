...
import com.sun.j2ee.blueprints.servicelocator.ejb.*; //import com.sun.j2ee.blueprints.bank.creditcardservice.CreditCardIntf;
...
public class CreditCardVerifier {
	...
	public CreditCardVerifier() {
		...
		CreditCardService ccSvc = (CreditCardService) ic
				.lookup(JNDINames.CREDIT_CARD_SERVICE_NAME);

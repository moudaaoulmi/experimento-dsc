...
import javax.naming.*; //import com.sun.j2ee.blueprints.activitysupplier.powebservice.ActivityPOIntf;
...
public class ActivitySupplierClient implements WSClient {
	...
	public String sendRequest(String xmlDoc) {
		...
		ActivityPurchaseOrderService svc = (ActivityPurchaseOrderService) ic
				.lookup(JNDINames.ACTIVITY_SERVICE_NAME);
		ActivityPOIntf port = (ActivityPOIntf) svc
				.getPort(ActivityPOIntf.class);

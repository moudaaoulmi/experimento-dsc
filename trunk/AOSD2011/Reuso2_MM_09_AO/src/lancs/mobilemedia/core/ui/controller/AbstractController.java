...
public abstract class AbstractController implements CommandListener, ControllerInterface {
	...
	public AbstractController(MainUIMidlet midlet){
		  this.midlet = midlet;		  
	}
...
//	public void appendController(AbstractController controller) {
//		appendController(this, controller);
//	}

//	private void appendController(AbstractController current, AbstractController next) {
//		if (current.getNextController() == null) current.setNextController(next);
//		else {
//			if (current.getNextController() instanceof AbstractController)
//			appendController((AbstractController)current.getNextController(), next);
//		}
//	}

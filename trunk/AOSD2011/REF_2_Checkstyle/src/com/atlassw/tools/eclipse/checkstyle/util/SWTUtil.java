...
public final class SWTUtil
{
    ...
    private static final class OnlyDigitsVerifyListener implements VerifyListener
    {
        ...
        private boolean intenalVerifyText(VerifyEvent e, boolean doit)
        {
            ...
            ControlListener, DisposeListener
    {
        ...
        public void shellActivated(ShellEvent e)
        {
            ...
            if (!mInitialyActivated)
            {
                ...
                if (bounds != null)
                {
                    ...
                    internalShellActivated2(shell, bounds);
        ...
        private void internalShellActivated2(Shell shell, IDialogSettings bounds)
        {
            mNewBounds = new Rectangle(bounds.getInt(X), bounds.getInt(Y), bounds

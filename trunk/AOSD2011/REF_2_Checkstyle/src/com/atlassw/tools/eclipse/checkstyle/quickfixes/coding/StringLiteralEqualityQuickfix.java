...
public class StringLiteralEqualityQuickfix extends AbstractASTResolution
{
            ...
            final int markerStartPosition)
    {
        ...
        return new ASTVisitorImplementation(lineInfo, markerStartPosition);
    }
    ...
    private class ASTVisitorImplementation extends ASTVisitor {
        IRegion lineInfo;
        int markerStartPosition;

        public ASTVisitorImplementation(IRegion lineInfo, int markerStartPosition)
        {
            this.lineInfo = lineInfo;
            this.markerStartPosition = markerStartPosition;
        }
